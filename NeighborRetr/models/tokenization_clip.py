...
def default_bpe():
    ...
    Returns:
        str: Path to the default BPE vocabulary file
    """
...
def bytes_to_unicode():
    ...
    Returns:
        dict: Mapping from bytes to unicode strings
    """
...
def get_pairs(word):
    ...
    Returns:
        set: Set of symbol pairs in word
    """
    pairs = set()
    prev_char = word[0]
    for char in word[1:]:
...
def basic_clean(text):
    """
    Perform basic text cleaning using ftfy and html unescaping.
...
class SimpleTokenizer(object):
    """
    CLIP tokenizer based on byte-level BPE.
    """
    
    def __init__(self, bpe_path: str = default_bpe()):
        """
        Initialize tokenizer with given BPE vocabulary.
        
        Args:
            bpe_path (str): Path to BPE vocabulary file
        """
